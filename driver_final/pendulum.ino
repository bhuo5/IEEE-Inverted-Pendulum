...
#define KP -10000 // proportion coefficient
...
void loop() {
  ...
  time_f = millis();
  set_speed = pid_compute(TARGET, actual_angle, omega, first_loop ? 0.0001 : (float) (time_f - time_i) / 1000); // put a convincing number of 3 ms first loop dt
